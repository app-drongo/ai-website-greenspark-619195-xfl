...
export default function Footer({
  logoText = 'GreenSpark',
  companyDescription = 'Empowering businesses to achieve carbon neutrality through innovative renewable energy solutions and sustainable technology. Join over 500 companies reducing their environmental impact.',
  contactEmail = 'hello@greenspark.com',
  contactPhone = '+1 (555) 123-4567',
  contactAddress = '123 Renewable Way, Suite 100, San Francisco, CA',
  newsletterTitle = 'Green Updates',
  newsletterDisclaimer = 'Get the latest sustainability insights and clean energy news. No spam, unsubscribe anytime.',
  section1Title = 'Solutions',
  section2Title = 'Company',
  section3Title = 'Resources',
  section4Title = 'Legal',
  copyrightText = '© 2024 GreenSpark. All rights reserved.',
  madeWithText = 'with renewable energy',
  socialText = 'Follow us:',
  social1Href = 'https://twitter.com/greenspark',
  social2Href = 'https://facebook.com/greenspark',
  social3Href = 'https://instagram.com/greenspark',
  social4Href = 'https://linkedin.com/company/greenspark',
  social5Href = 'https://github.com/greenspark',
}: FooterProps) {
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Wind Power', href: '/wind' },
        { name: 'Energy Storage', href: '/storage' },
        { name: 'Carbon Tracking', href: '/carbon-tracking' },
        { name: 'Sustainability Audit', href: '/audit' },
        { name: 'Green Consulting', href: '/consulting' },
      ],
    },
    {
      title: section2Title,
