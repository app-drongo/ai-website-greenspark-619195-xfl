...
const DEFAULT_HERO = {
  ...
  title: 'Start sustainable future with',
  ...
  secondaryCTA: 'Watch Impact Demo',
  primaryCTAHref: '/',
  secondaryCTAHref: '#demo',
  imageUrl:
    'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Sustainable technology dashboard',
  statsLabel1: 'CO2 Saved',
  statsValue1: '2.4 tons/month',
  statsLabel2: 'Green Score',
